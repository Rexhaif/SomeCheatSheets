...
\begin{multicols}{4}
 ...
 \end{itemize}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{9. Криволинейный интеграл 2-го рода (определение, свойства)}
 \begin{Def}
 ...
 % \end{Th}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{10. Формула Грина и её следствие}
 \begin{Th}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{11. Поверхности и их ориентация. Площадь поверхности}
 Поверхность.
 \begin{Def}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{12. Поверхностный интеграл 1-го рода}
 \begin{Def}
 ...
 \end{Def}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{13. Поверхностный интеграл 2-го рода}
 \begin{Def}
 ...
 \end{Def}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{14. Формула Гаусса-Остроградского}
 \begin{Th}
 ...
 \end{Th}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{16. Градиент, дивергенция, ротор}
 Градиент
 \begin{Def}
 ...
 \end{Th}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{18. Числовой ряд, его сумма, сходимость, остаток.}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{19. Необходимое условие сходимости числового ряда.}
 \begin{Th}
 ...
 \end{Th}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{20. Расходимость гармонического ряда.}
 \begin{Th}
 ...
 \end{Th}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{22. Признак Даламбера сходимости числового ряда.}
 \begin{Th}
 ...
 \end{Th}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{23. Радикальный признак Коши}
 \begin{Th}
 ...
 \end{Def}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{29. Признак Вейерштрасса равномерной сходимости функциональных рядов.}
 \begin{Th}
 ...
 \end{Th}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{30. Теорема о непрерывности суммы равномерно сходящегося ряда (без доказательства).}
 \begin{Th}
 ...
 \end{Th}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{33. Радиус, интервал и область сходимости степенного ряда.}
 \begin{Def}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{34. Ряды Тейлора и Маклорена. Достаточное условие разложимости функции в ряд Тейлора (без доказательства).}
 \begin{Def}
 ...
 \end{Th}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{35.  Разложение основных элементарных функций в ряд Маклорена.}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{36. Тригонометрические ряды Фурье.}
 \begin{Def}
 ...
 \end{Def}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \subsection{37. Достаточное условие сходимости тригонометрического ряда Фурье в точке (без доказательства).}
 \begin{Th}
